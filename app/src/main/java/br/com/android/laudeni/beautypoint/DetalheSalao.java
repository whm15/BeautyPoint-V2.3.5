...
public class DetalheSalao extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Salao salao = (Salao) getIntent().getSerializableExtra("salao");
        ...
        Button botaoAG = (Button) findViewById(R.id.dt_cad);

        botaoAG.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent i = new Intent( DetalheSalao.this, AgendamentoOpcao.class );
                i.putExtra("salaodt", salao);
                startActivity(i);
            }
        });
